...
Compared to neural network, it sometimes gives a cleaner and more powerful way of learning complex non-linear functions. \fxnote{(TODO: What does more powerful mean?)}
...
\end{equation}
We must choose the value of the constant $C$. \fxnote{(TODO: what is its effect? Some regularization thing.)}
